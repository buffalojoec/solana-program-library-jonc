...
import {    
    ...
    createSimple as createSimpleRecord,
...
async function main() {
    ...
    // // // ----------------------------------------------------------------
    // /// TODO: 2. CREATE DYNAMIC RECORD - TODO: can use this for MIN SIZE AND RENT:
    
    // console.log(`\nCreating a Dynamic Simple Record...`);

    // // TODO: CREATE DYNAMIC TEST DATA
    ...
    //         simpleRecordResult] = await createSimpleRecord(            
    ...
    // // Simple log and Validation
    // console.log(`\nAccount Key Compare:`, 
    //             `\nBefore: `, recordAccountPublicKey.toBase58(),
    //             `\nAfter : `, simpleRecordPublicKey.toBase58());

    // console.log(`\nData Compare: Message:`,
    //             `\nBefore: `, simpleRecord!.message,
    //             `\nAfter : `, simpleRecordResult!.message);    
    
    // const simpleKeyCreateFormatted = new PublicKey(simpleRecordResult!.key).toBase58()
    // console.log(`\nData: Compare Key:`,
    ...
    // // ----------------------------------------------------------------
    // /// TODO: CREATE DYNAMIC RECORD - TODO: can use this for MIN SIZE AND RENT:
    ...
    // assert.strictEqual(simpleRecordPublicKey.toBase58(), metaDataPublicKeyUpdate.toBase58());
    // // assert.strictEqual(metadataPublicKeyFormatted, metaDataPublicKeyAfter);
    // assert.strictEqual(meta_data_update!.name, metaDataRecordAccountUpdated!.name);
    // // assert.notStrictEqual(metaDataNew!.name, metaDataRecordAccountUpdated!.name);      
